...
-- create indexes for 1st problem statement:
-- Index on tourId column in the matches table
CREATE INDEX idx_tourId_matches ON matches (tourId);

-- Index on tourId column in the tours table
CREATE INDEX idx_tourId_tours ON tours (id);

-- Optional: Index on the name column in the tours table
